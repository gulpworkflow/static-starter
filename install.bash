...
STARTER_BASE_CLONE_URL="git@github.com:gulpworkflow/static-starter.git"             # Github SSH clone URL of starter base repository
STARTER_BASE_NAME="static-starter"                                                 # Starter base repository name
